...
ssh_config = SSHConfig.model_validate({})
db_config = DBConfig.model_validate({})
...
async def run_async_migrations() -> None:
    ...
    ssh_address = (ssh_config.host, ssh_config.port)
    remote_bind_address = (db_config.db_host, db_config.db_port)
    local_bind_address = ("localhost", db_config.db_port)
